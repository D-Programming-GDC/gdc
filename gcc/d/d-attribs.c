...
{
  ATTR_SPEC ("noreturn", 0, 0, true, false, false,
	     handle_noreturn_attribute, false),
  ATTR_SPEC ("leaf", 0, 0, true, false, false,
	     handle_leaf_attribute, false),
  ATTR_SPEC ("const", 0, 0, true, false, false,
	     handle_const_attribute, false),
  ATTR_SPEC ("malloc", 0, 0, true, false, false,
	     handle_malloc_attribute, false),
  ATTR_SPEC ("returns_twice", 0, 0, true, false, false,
	     handle_returns_twice_attribute, false),
  ATTR_SPEC ("pure", 0, 0, true, false, false,
	     handle_pure_attribute, false),
  ATTR_SPEC ("nonnull", 0, -1, false, true, true,
	     handle_nonnull_attribute, false),
  ATTR_SPEC ("nothrow", 0, 0, true, false, false,
	     handle_nothrow_attribute, false),
  ATTR_SPEC ("transaction_pure", 0, 0, false, true, true,
	     handle_transaction_pure_attribute, false),
  ATTR_SPEC ("no vops", 0, 0, true, false, false,
	     handle_novops_attribute, false),
  ATTR_SPEC ("type generic", 0, 0, false, true, true,
	     handle_type_generic_attribute, false),
  ATTR_SPEC ("fn spec", 1, 1, false, true, true,
	     handle_fnspec_attribute, false),
  ATTR_SPEC (NULL, 0, 0, false, false, false, NULL, false),
};

/* Table of D language attributes exposed by `gcc.attribute' UDAs.  */
const attribute_spec d_langhook_attribute_table[] =
{
  ATTR_SPEC ("noinline", 0, 0, true, false, false,
	     d_handle_noinline_attribute, false),
  ATTR_SPEC ("forceinline", 0, 0, true, false, false,
	     d_handle_forceinline_attribute, false),
  ATTR_SPEC ("flatten", 0, 0, true, false, false,
	     d_handle_flatten_attribute, false),
  ATTR_SPEC ("target", 1, -1, true, false, false,
	     d_handle_target_attribute, false),
  ATTR_SPEC ("noclone", 0, 0, true, false, false,
	     d_handle_noclone_attribute, false),
  ATTR_SPEC ("section", 1, 1, true, false, false,
	     d_handle_section_attribute, false),
  ATTR_SPEC ("alias", 1, 1, true, false, false,
	     d_handle_alias_attribute, false),
  ATTR_SPEC ("weak", 0, 0, true, false, false,
