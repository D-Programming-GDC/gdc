...
+target_modules = { module= libphobos; };
 target_modules = { module= libtermcap; no_check=true;
                    missing=mostlyclean;
                    missing=clean;
@@ -279,6 +280,8 @@ flags_to_pass = { flag= GCJ_FOR_TARGET ; };
...
@@ -541,6 +544,9 @@ dependencies = { module=configure-target-libgo; on=all-target-libstdc++-v3; };
...
@@ -604,6 +611,8 @@ languages = { language=objc;	gcc-check-target=check-objc;
...
@@ -280,6 +283,7 @@ BASE_TARGET_EXPORTS = \
...
@@ -347,6 +351,7 @@ DLLTOOL_FOR_BUILD = @DLLTOOL_FOR_BUILD@
...
@@ -529,6 +535,7 @@ RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) @RAW_CXX_FOR_TARGET@
...
@@ -751,6 +759,8 @@ BASE_FLAGS_TO_PASS = \
...
+	'GDC=$(GDC)' \
 	...
 	'LIPO=$(LIPO)' \
 	'NM=$(NM)' \
@@ -852,6 +863,8 @@ EXTRA_TARGET_FLAGS = \
...
@@ -1119,6 +1133,7 @@ all-target: maybe-all-target-libquadmath
...
@@ -1213,6 +1228,7 @@ info-target: maybe-info-target-libquadmath
...
@@ -1300,6 +1316,7 @@ dvi-target: maybe-dvi-target-libquadmath
...
@@ -1387,6 +1404,7 @@ pdf-target: maybe-pdf-target-libquadmath
...
@@ -1474,6 +1492,7 @@ html-target: maybe-html-target-libquadmath
...
@@ -1561,6 +1580,7 @@ TAGS-target: maybe-TAGS-target-libquadmath
...
@@ -1648,6 +1668,7 @@ install-info-target: maybe-install-info-target-libquadmath
...
@@ -1735,6 +1756,7 @@ install-pdf-target: maybe-install-pdf-target-libquadmath
...
@@ -1822,6 +1844,7 @@ install-html-target: maybe-install-html-target-libquadmath
...
@@ -1909,6 +1932,7 @@ installcheck-target: maybe-installcheck-target-libquadmath
...
@@ -1996,6 +2020,7 @@ mostlyclean-target: maybe-mostlyclean-target-libquadmath
...
@@ -2083,6 +2108,7 @@ clean-target: maybe-clean-target-libquadmath
...
@@ -2170,6 +2196,7 @@ distclean-target: maybe-distclean-target-libquadmath
...
@@ -2257,6 +2284,7 @@ maintainer-clean-target: maybe-maintainer-clean-target-libquadmath
...
@@ -2680,6 +2710,7 @@ install-strip-target:  \
...
@@ -41326,6 +41357,464 @@ maintainer-clean-target-libgo:
...
@@ -49492,6 +49989,7 @@ configure-target-libquadmath: stage_last
...
@@ -49526,6 +50024,7 @@ configure-target-libquadmath: maybe-all-gcc
...
@@ -50319,6 +50818,9 @@ configure-target-libgo: maybe-all-target-libstdc++-v3
...
@@ -50365,6 +50867,7 @@ all-target-liboffloadmic: maybe-all-target-libgomp
...
@@ -50436,6 +50939,7 @@ configure-target-libquadmath: maybe-all-target-libgcc
...
@@ -50479,6 +50983,8 @@ configure-target-libobjc: maybe-all-target-newlib maybe-all-target-libgloss
