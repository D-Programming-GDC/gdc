...
@@ -1617,12 +1617,12 @@ their runtime libraries should be built.  For a list of valid values for
...
@@ -1350,6 +1350,15 @@ called @dfn{specs}.
...
+
 ...
 @c Pascal:
 @c @var{file}.p
@@ -1385,6 +1394,7 @@ objective-c  objective-c-header  objective-c-cpp-output
...
@@ -309,6 +309,16 @@ capability is typically utilized to implement the HSA runtime API's HSAIL
