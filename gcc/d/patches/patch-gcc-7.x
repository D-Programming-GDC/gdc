...
@@ -29652,7 +29652,8 @@ rs6000_output_function_epilogue (FILE *file,
       if (lang_GNU_C ()
...
@@ -1328,6 +1328,15 @@ called @dfn{specs}.
...
+
 ...
 @c Pascal:
 @c @var{file}.p
@@ -1363,6 +1372,7 @@ objective-c  objective-c-header  objective-c-cpp-output
...
@@ -22088,6 +22098,8 @@ gen_compile_unit_die (const char *filename)
...
@@ -23547,7 +23559,7 @@ declare_in_namespace (tree thing, dw_die_ref context_die)
...
@@ -23570,7 +23582,7 @@ gen_namespace_die (tree decl, dw_die_ref context_die)
     {
...
@@ -23637,7 +23649,7 @@ gen_decl_die (tree decl, tree origin, struct vlr_context *ctx,
       break;
...
@@ -24171,7 +24183,7 @@ dwarf2out_decl (tree decl)
     case CONST_DECL:
