...
@@ -825,6 +827,7 @@ BCONFIG_H = bconfig.h $(build_xm_file_list)
...
@@ -882,9 +885,11 @@ EXCEPT_H = except.h $(HASHTAB_H)
...
@@ -1156,6 +1161,9 @@ C_TARGET_OBJS=@c_target_objs@
...
@@ -1707,6 +1715,7 @@ bconfig.h: cs-bconfig.h ; @true
...
+tm_d.h: cs-tm_d.h ; @true
 ...
 cs-config.h: Makefile
 	TARGET_CPU_DEFAULT="" \
@@ -1733,6 +1742,11 @@ cs-tm_p.h: Makefile
...
@@ -2019,6 +2033,12 @@ default-c.o: config/default-c.c
...
+
 ...
 DRIVER_DEFINES = \
@@ -2305,6 +2325,15 @@ s-common-target-hooks-def-h: build/genhooks$(build_exeext)
...
@@ -2328,6 +2357,7 @@ s-tm-texi: build/genhooks$(build_exeext) $(srcdir)/doc/tm.texi.in
...
@@ -2465,7 +2495,7 @@ generated_files = config.h tm.h $(TM_P_H) $(TM_H) multilib.h \
...
+       c-family/c-target-hooks-def.h d/d-target-hooks-def.h params.list case-cfn-macros.h \
 ...
 #
@@ -2607,7 +2637,7 @@ build/genrecog.o : genrecog.c $(RTL_BASE_H) $(BCONFIG_H) $(SYSTEM_H)	\
...
+	tmake_file="${tmake_file} alpha/t-linux alpha/t-alpha"
 	...
 	;;
 alpha*-*-freebsd*)
@@ -3096,6 +3120,10 @@ if [ "$common_out_file" = "" ]; then
   fi
 fi
...
+
 ...
 # too).
 case ${with_cpu} in
@@ -4480,12 +4508,14 @@ case ${target} in
...
@@ -804,6 +804,9 @@ extern unsigned char rs6000_recip_bits[];
 #define TARGET_CPU_CPP_BUILTINS() \
