...
+	tmake_file="${tmake_file} s390/t-s390"
 ...
 score-*-elf)
 	gas=yes
@@ -2719,6 +2745,10 @@ if [ "$common_out_file" = "" ]; then
   fi
 fi
...
@@ -335,6 +335,9 @@ extern int dot_symbols;
     }							\
   while (0)
