...
@@ -604,6 +611,8 @@ languages = { language=go;	gcc-check-target=check-go;
...
@@ -551,6 +557,7 @@ CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) @CXX_FOR_TARGET@
...
@@ -575,6 +582,7 @@ LIBCFLAGS_FOR_TARGET = $(CFLAGS_FOR_TARGET)
...
@@ -774,6 +782,8 @@ BASE_FLAGS_TO_PASS = \
...
+	'GDC=$(GDC)' \
 	...
 	'LIPO=$(LIPO)' \
 	'NM=$(NM)' \
@@ -889,6 +900,8 @@ EXTRA_TARGET_FLAGS = \
...
@@ -1158,6 +1172,7 @@ all-target: maybe-all-target-libgfortran
...
@@ -1251,6 +1266,7 @@ info-target: maybe-info-target-libgfortran
...
@@ -1337,6 +1353,7 @@ dvi-target: maybe-dvi-target-libgfortran
...
@@ -1423,6 +1440,7 @@ pdf-target: maybe-pdf-target-libgfortran
...
@@ -1509,6 +1527,7 @@ html-target: maybe-html-target-libgfortran
...
@@ -1595,6 +1614,7 @@ TAGS-target: maybe-TAGS-target-libgfortran
...
@@ -1681,6 +1701,7 @@ install-info-target: maybe-install-info-target-libgfortran
...
@@ -1767,6 +1788,7 @@ install-pdf-target: maybe-install-pdf-target-libgfortran
...
@@ -1853,6 +1875,7 @@ install-html-target: maybe-install-html-target-libgfortran
...
@@ -1939,6 +1962,7 @@ installcheck-target: maybe-installcheck-target-libgfortran
...
@@ -2025,6 +2049,7 @@ mostlyclean-target: maybe-mostlyclean-target-libgfortran
...
@@ -2111,6 +2136,7 @@ clean-target: maybe-clean-target-libgfortran
...
@@ -2197,6 +2223,7 @@ distclean-target: maybe-distclean-target-libgfortran
...
@@ -2283,6 +2310,7 @@ maintainer-clean-target: maybe-maintainer-clean-target-libgfortran
...
@@ -2713,6 +2743,7 @@ install-strip-target:  \
...
@@ -46570,6 +46601,464 @@ maintainer-clean-target-libhsail-rt:
...
+
 ...
 maybe-configure-target-libtermcap:
 @if gcc-bootstrap
@@ -51864,6 +52353,14 @@ check-gcc-brig:
...
@@ -54742,6 +55239,7 @@ configure-target-libgfortran: stage_last
...
@@ -54777,6 +55275,7 @@ configure-target-libgfortran: maybe-all-gcc
...
@@ -55803,6 +56302,9 @@ configure-target-libgo: maybe-all-target-libstdc++-v3
...
@@ -55848,6 +56350,7 @@ all-target-liboffloadmic: maybe-all-target-libgomp
...
@@ -55930,6 +56433,7 @@ configure-target-libgfortran: maybe-all-target-libgcc
...
@@ -55973,6 +56477,8 @@ configure-target-libgo: maybe-all-target-newlib maybe-all-target-libgloss
