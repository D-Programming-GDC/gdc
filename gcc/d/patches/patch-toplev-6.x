...
+GDC_FOR_TARGET
 ...
 AS_FOR_TARGET
 DLLTOOL_FOR_TARGET
@@ -1604,6 +1607,8 @@ Some influential environment variables:
...
+              GDC for the target
   AR_FOR_TARGET
               AR for the target
   AS_FOR_TARGET
@@ -2762,7 +2767,8 @@ target_libraries="target-libgcc \
 		${libgcj} \
 		target-libobjc \
 		target-libada \
-		target-libgo"
...
@@ -4022,6 +4028,7 @@ if test "${build}" != "${host}" ; then
...
+
 ...
 #ifdef __GNUC__
   gcc_yay;
@@ -14325,6 +14495,51 @@ $as_echo "pre-installed" >&6; }
   fi
 fi
...
+target_modules = { module= libphobos; };
 target_modules = { module= libtermcap; no_check=true;
                    missing=mostlyclean;
                    missing=clean;
@@ -281,6 +282,7 @@ flags_to_pass = { flag= GCJ_FOR_TARGET ; };
...
@@ -527,6 +531,7 @@ RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) @RAW_CXX_FOR_TARGET@
...
+	'GDC=$(GDC)' \
 	...
 	'LIPO=$(LIPO)' \
 	'NM=$(NM)' \
@@ -860,6 +867,7 @@ EXTRA_TARGET_FLAGS = \
...
@@ -1127,6 +1136,7 @@ all-target: maybe-all-target-libquadmath
...
@@ -1221,6 +1231,7 @@ info-target: maybe-info-target-libquadmath
...
@@ -1308,6 +1319,7 @@ dvi-target: maybe-dvi-target-libquadmath
...
@@ -1395,6 +1407,7 @@ pdf-target: maybe-pdf-target-libquadmath
...
@@ -1482,6 +1495,7 @@ html-target: maybe-html-target-libquadmath
...
@@ -1569,6 +1583,7 @@ TAGS-target: maybe-TAGS-target-libquadmath
...
@@ -1656,6 +1671,7 @@ install-info-target: maybe-install-info-target-libquadmath
...
@@ -1743,6 +1759,7 @@ install-pdf-target: maybe-install-pdf-target-libquadmath
...
@@ -1830,6 +1847,7 @@ install-html-target: maybe-install-html-target-libquadmath
...
@@ -1917,6 +1935,7 @@ installcheck-target: maybe-installcheck-target-libquadmath
...
@@ -2004,6 +2023,7 @@ mostlyclean-target: maybe-mostlyclean-target-libquadmath
...
@@ -2091,6 +2111,7 @@ clean-target: maybe-clean-target-libquadmath
...
@@ -2178,6 +2199,7 @@ distclean-target: maybe-distclean-target-libquadmath
...
@@ -2265,6 +2287,7 @@ maintainer-clean-target: maybe-maintainer-clean-target-libquadmath
...
@@ -2688,6 +2713,7 @@ install-strip-target:  \
...
@@ -41340,6 +41366,464 @@ maintainer-clean-target-libgo:
...
@@ -49506,6 +49998,7 @@ configure-target-libquadmath: stage_last
...
@@ -49540,6 +50033,7 @@ configure-target-libquadmath: maybe-all-gcc
