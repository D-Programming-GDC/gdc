...
@@ -554,6 +557,9 @@ dependencies = { module=configure-target-libgo; on=all-target-libstdc++-v3; };
...
@@ -576,6 +582,7 @@ dependencies = { module=all-target-liboffloadmic; on=all-target-libgomp; };
...
@@ -618,6 +625,8 @@ languages = { language=objc;	gcc-check-target=check-objc;
...
@@ -1133,6 +1147,7 @@ all-target: maybe-all-target-libquadmath
...
@@ -1227,6 +1242,7 @@ info-target: maybe-info-target-libquadmath
...
@@ -1314,6 +1330,7 @@ dvi-target: maybe-dvi-target-libquadmath
...
@@ -1401,6 +1418,7 @@ pdf-target: maybe-pdf-target-libquadmath
...
@@ -1488,6 +1506,7 @@ html-target: maybe-html-target-libquadmath
...
@@ -1575,6 +1594,7 @@ TAGS-target: maybe-TAGS-target-libquadmath
...
@@ -1662,6 +1682,7 @@ install-info-target: maybe-install-info-target-libquadmath
...
@@ -1749,6 +1770,7 @@ install-pdf-target: maybe-install-pdf-target-libquadmath
...
@@ -1836,6 +1858,7 @@ install-html-target: maybe-install-html-target-libquadmath
...
@@ -1923,6 +1946,7 @@ installcheck-target: maybe-installcheck-target-libquadmath
...
@@ -2010,6 +2034,7 @@ mostlyclean-target: maybe-mostlyclean-target-libquadmath
...
@@ -2097,6 +2122,7 @@ clean-target: maybe-clean-target-libquadmath
...
@@ -2184,6 +2210,7 @@ distclean-target: maybe-distclean-target-libquadmath
...
@@ -2271,6 +2298,7 @@ maintainer-clean-target: maybe-maintainer-clean-target-libquadmath
...
@@ -2704,6 +2734,7 @@ install-strip-target:  \
...
@@ -41753,6 +41784,464 @@ maintainer-clean-target-libgo:
...
@@ -49989,6 +50486,7 @@ configure-target-libquadmath: stage_last
...
@@ -50023,6 +50521,7 @@ configure-target-libquadmath: maybe-all-gcc
...
@@ -50872,6 +51371,9 @@ configure-target-libgo: maybe-all-target-libstdc++-v3
...
@@ -50918,6 +51420,7 @@ all-target-liboffloadmic: maybe-all-target-libgomp
...
@@ -50990,6 +51493,7 @@ configure-target-libquadmath: maybe-all-target-libgcc
...
@@ -51033,6 +51537,8 @@ configure-target-libobjc: maybe-all-target-newlib maybe-all-target-libgloss
...
@@ -4048,6 +4054,7 @@ if test "${build}" != "${host}" ; then
...
+
 ...
 #ifdef __GNUC__
   gcc_yay;
@@ -14369,6 +14539,51 @@ $as_echo "pre-installed" >&6; }
   fi
 fi
...
+		target-libphobos"
 ...
 # these tools are built using the target libraries, and are intended to
 # run only in the target environment
@@ -1365,6 +1366,7 @@ if test "${build}" != "${host}" ; then
   GCJ_FOR_BUILD=${GCJ_FOR_BUILD-gcj}
   GFORTRAN_FOR_BUILD=${GFORTRAN_FOR_BUILD-gfortran}
   GOC_FOR_BUILD=${GOC_FOR_BUILD-gccgo}
+  GDC_FOR_BUILD=${GDC_FOR_BUILD-gdc}
...
+  GDC_FOR_BUILD="\$(GDC)"
   ...
   LD_FOR_BUILD="\$(LD)"
   NM_FOR_BUILD="\$(NM)"
@@ -3305,6 +3308,7 @@ AC_SUBST(DLLTOOL_FOR_BUILD)
...
@@ -3415,6 +3419,7 @@ NCN_STRICT_CHECK_TARGET_TOOLS(GCC_FOR_TARGET, gcc, ${CC_FOR_TARGET})
...
@@ -3450,6 +3455,8 @@ GCC_TARGET_TOOL(gfortran, GFORTRAN_FOR_TARGET, GFORTRAN,
