...
+	tmake_file="${tmake_file} alpha/t-linux alpha/t-alpha"
 	...
 	;;
 alpha*-*-freebsd*)
@@ -3010,6 +3034,10 @@ if [ "$common_out_file" = "" ]; then
   fi
 fi
...
+
 ...
 # too).
 case ${with_cpu} in
@@ -4305,12 +4333,14 @@ case ${target} in
