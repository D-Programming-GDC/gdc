...
--- a/configure
+++ b/configure
@@ -2754,7 +2754,8 @@ target_libraries="target-libgcc \
 		${libgcj} \
 		target-libobjc \
 		target-libada \
-		target-libgo"
...
--- a/Makefile.def
+++ b/Makefile.def
@@ -146,6 +146,7 @@ target_modules = { module= libquadmath; };
...
+target_modules = { module= libphobos; };
 target_modules = { module= libtermcap; no_check=true;
                    missing=mostlyclean;
                    missing=clean;
@@ -533,6 +534,8 @@ dependencies = { module=configure-target-libgo; on=all-target-libstdc++-v3; };
...
@@ -596,6 +599,8 @@ languages = { language=objc;	gcc-check-target=check-objc;
...
@@ -1100,6 +1101,7 @@ all-target: maybe-all-target-libquadmath
...
@@ -1192,6 +1194,7 @@ info-target: maybe-info-target-libquadmath
...
@@ -1277,6 +1280,7 @@ dvi-target: maybe-dvi-target-libquadmath
...
@@ -1362,6 +1366,7 @@ pdf-target: maybe-pdf-target-libquadmath
...
@@ -1447,6 +1452,7 @@ html-target: maybe-html-target-libquadmath
...
@@ -1532,6 +1538,7 @@ TAGS-target: maybe-TAGS-target-libquadmath
...
@@ -1617,6 +1624,7 @@ install-info-target: maybe-install-info-target-libquadmath
...
@@ -1702,6 +1710,7 @@ install-pdf-target: maybe-install-pdf-target-libquadmath
...
@@ -1787,6 +1796,7 @@ install-html-target: maybe-install-html-target-libquadmath
...
@@ -1872,6 +1882,7 @@ installcheck-target: maybe-installcheck-target-libquadmath
...
@@ -1957,6 +1968,7 @@ mostlyclean-target: maybe-mostlyclean-target-libquadmath
...
@@ -2042,6 +2054,7 @@ clean-target: maybe-clean-target-libquadmath
...
@@ -2127,6 +2140,7 @@ distclean-target: maybe-distclean-target-libquadmath
...
@@ -2212,6 +2226,7 @@ maintainer-clean-target: maybe-maintainer-clean-target-libquadmath
...
@@ -2616,6 +2633,7 @@ install-strip-target:  \
...
@@ -39845,6 +39863,463 @@ maintainer-clean-target-libgo:
...
@@ -48005,6 +48488,7 @@ configure-target-libquadmath: stage_last
...
@@ -48038,6 +48522,7 @@ configure-target-libquadmath: maybe-all-gcc
...
@@ -48830,6 +49315,8 @@ configure-target-libgo: maybe-all-target-libstdc++-v3
...
@@ -48940,6 +49427,7 @@ configure-target-libquadmath: maybe-all-target-libgcc
...
@@ -48981,6 +49469,8 @@ configure-target-libobjc: maybe-all-target-newlib maybe-all-target-libgloss
