...
outdata(Symbol * sym)
{
    ...
    {   // %% auto type generated by dt2tree should be made canonical type,
        // this fixes issues with aliasing in gimplification.
        if (D_IS_CTOR_ELEMLIST(DECL_INITIAL(t)))
        {
            tree i = TREE_TYPE(DECL_INITIAL(t));
            TYPE_CANONICAL(i) = TYPE_CANONICAL(TREE_TYPE(t));
        }
    }
#endif
