...
static AsmOpInfo asmOpInfo[N_AsmOpInfo] = {
    /* Op_Invalid   */  { I7 },
    /* Op_Adjust    */  { 0,0,0,             0, Clb_EAX /*just AX*/, I2 },
    /* Op_Dst       */  { D|mr,  0,    0,    1, I3  },
    /* Op_Upd       */  { U|mr,  0,    0,    1, I3  },
    /* Op_DstW      */  { D|mr,  0,    0,    Word_Types,   I3   },
    /* Op_DstF      */  { D|mr,  0,    0,    1, Clb_Flags, I2   },
    /* Op_UpdF      */  { U|mr,  0,    0,    1, Clb_Flags, I2   },
    /* Op_DstSrc    */  { D|mr,  mri,  0,/**/1, I3  },
    /* Op_DstSrcF   */  { D|mr,  mri,  0,/**/1, Clb_Flags, I2   },
    /* Op_UpdSrcF   */  { U|mr,  mri,  0,/**/1, Clb_Flags, I2   },
    /* Op_DstSrcFW  */  { D|mr,  mri,  0,/**/Word_Types, Clb_Flags, I2  },
    /* Op_UpdSrcFW  */  { U|mr,  mri,  0,/**/Word_Types, Clb_Flags, I2  },
    /* Op_DstSrcSSE */  { U|sse, ssem, 0,     I4 },  // some may not be update %%
    /* Op_DstSrcMMX */  { U|mmx, mmxm, 0,     I4 },  // some may not be update %%
    /* Op_DstSrcImmS*/  { U|sse, ssem, N|imm, I4 },  // some may not be update %%
    /* Op_DstSrcImmM*/  { U|mmx, mmxm, N|imm, I4 },  // some may not be update %%
    /* Op_UpdSrcShft*/  { U|mr,  reg,  N|shft, 1, Clb_Flags, I2 }, // 16/32 only
    /* Op_DstSrcNT  */  { D|mr,  mr,   0,    0, I3  }, // used for movd .. operands can be rm32,sse,mmx
    /* Op_UpdSrcNT  */  { U|mr,  mr,   0,    0, I3  }, // used for movd .. operands can be rm32,sse,mmx
    /* Op_DstMemNT  */  { D|mem, 0,    0,    I4 },
    /* Op_DstRMBNT  */  { D|mr,  0,    0,    Byte_NoType, I3 },
    /* Op_DstRMWNT  */  { D|mr,  0,    0,    I4 },
    /* Op_UpdUpd    */  { U|mr,U|mr,   0,/**/1, I3  },
    /* Op_UpdUpdF   */  { U|mr,U|mr,   0,/**/1, Clb_Flags, I2 },
    /* Op_Src       */  {   mri, 0,    0,    1, I3  },
    /* Op_SrcRMWNT  */  {   mr,  0,    0,    0, I3  },
    /* Op_SrcW      */  {   mri, 0,    0,    Word_Types, I3   },
    /* Op_SrcImm    */  {   imm, I6 },
    /* Op_Src_DXAXF */  {   mr,  0,    0,    1, Clb_SizeDXAX|Clb_Flags, I2 },
    /* Op_SrcMemNT  */  {   mem, 0,    0,    I4     },
    /* Op_SrcMemNTF */  {   mem, 0,    0,    0, Clb_Flags, I2 },
    /* Op_SrcSrc    */  {   mr,  mri,  0,    1, I3  },
    /* Op_SrcSrcF   */  {   mr,  mri,  0,    1, Clb_Flags, I2 },
    /* Op_SrcSrcFW  */  {   mr,  mri,  0,    Word_Types, Clb_Flags, I2  },
    /* Op_SrcSrcSSEF*/  {   sse, ssem, 0,    0, Clb_Flags, I2 },
    /* Op_SrcSrcMMX */  {   mmx, mmx,  0,    I4 },
    /* Op_Shift     */  { D|mr,N|shft, 0,/**/1, Clb_Flags, I2 },
    /* Op_Branch    */  {   mri, I6 },
    /* Op_CBranch   */  {   imm, I6 },
    /* Op_0         */  {   0,0,0,  I4 },
    /* Op_0_AX      */  {   0,0,0,           0, Clb_SizeAX, I2 },
    /* Op_0_DXAX    */  {   0,0,0,           0, Clb_SizeDXAX, I2 }, // but for cwd/cdq -- how do know the size..
    /* Op_Loop      */  {   imm, 0,    0,    0, Clb_CX, I2  },
    /* Op_Flags     */  {   0,0,0,           0, Clb_Flags,  I2 },
    /* Op_F0_ST     */  {   0,0,0,           0, Clb_ST, I2  },
    /* Op_F0_P      */  {   0,0,0,           0, Clb_ST, I2  }, // push, pops, etc. not sure how to inform gcc..
    /* Op_Fs_P      */  {   mem, 0,    0,    0, Clb_ST, I2  }, // "
    /* Op_Fis       */  {   mem, 0,    0,    FPInt_Types, I3 }, // only 16bit and 32bit, DMD defaults to 16bit
    /* Op_Fis_ST    */  {   mem, 0,    0,    FPInt_Types, Clb_ST, I2 }, // "
    /* Op_Fis_P     */  {   mem, 0,    0,    FPInt_Types, Clb_ST, I2 }, // push and pop, fild so also 64 bit
    /* Op_Fid       */  { D|mem, 0,    0,    FPInt_Types, I3 }, // only 16bit and 32bit, DMD defaults to 16bit
    /* Op_Fid_P     */  { D|mem, 0,    0,    FPInt_Types, Clb_ST, I2 }, // push and pop, fild so also 64 bit
    /* Op_Ffd       */  { D|mfp, 0,    0,    FP_Types, 0, Next_Form, Op_FfdR }, // only 16bit and 32bit, DMD defaults to 16bit, reg form doesn't need type
    /* Op_FfdR      */  { D|rfp, 0,    0,    I4 },
    /* Op_Ffd_P     */  { D|mfp, 0,    0,    FP_Types, Clb_ST, Next_Form, Op_FfdR_P, }, // pop, fld so also 80 bit, "
    /* Op_FfdR_P    */  { D|rfp, 0,    0,    0,        Clb_ST, I2 },
    /* Op_Fd_P      */  { D|mem, 0,    0,    0, Clb_ST, I2  }, // "
    /* Op_FdST      */  { D|rfp, 0,    0,    I4 },
    /* Op_FMath     */  {   mfp, 0,    0,    FP_Types, Clb_ST, Next_Form, Op_FdSTiSTi  }, // and only single or double prec
    /* Op_FdSTiSTi  */  { D|rfp, rfp,  0,    I4 },
    ...
    /* Op_FCmpFlg   */  {   rfp, rfp,  0,    0,        Clb_Flags, I2 },
    /* Op_FCmpFlgP  */  {   rfp, rfp,  0,    0,        Clb_Flags, I2 }, // pops
    /* Op_fld       */  {   mfp, 0,    0,    FP_Types, Clb_ST, Next_Form, Op_fldR },
    /* Op_fldR      */  {   rfp, 0,    0,    0,        Clb_ST, I2 },
    ...
    /* Op_fxch0     */  {   0,   0,    0,    0,        Clb_ST, I2 }, // Also clobbers ST(1)
    /* Op_SizedStack*/  {   0,   0,    0,    0,        Clb_SP, I2 }, // type suffix special case
    /* Op_bound     */  {   mr,  mri,  0,    Word_Types, I3 }, // operands *not* reversed for gas
    /* Op_bswap     */  { D|r32, I6 },
    /* Op_cmps      */  {   mem, mem, 0,     1, Clb_DI|Clb_SI|Clb_Flags, I2 },
    /* Op_cmpsd     */  {   0,   0,   0,     0, Clb_DI|Clb_SI|Clb_Flags, Next_Form, Op_DstSrcImmS },
    /* Op_cmpsX     */  {   0,   0,   0,     0, Clb_DI|Clb_SI|Clb_Flags, I2 },
    /* Op_cmpxchg8b */  { D|mem/*64*/,0,0,   0, Clb_SizeDXAX/*32*/|Clb_Flags, Out_Mnemonic, Mn_cmpxchg8b },
    /* Op_cmpxchg   */  { D|mr,  reg, 0,     1, Clb_SizeAX|Clb_Flags,    I2 },
    /* Op_cpuid     */  {   0,0,0,    I4    },  // Clobbers eax, ebx, ecx, and edx. Handled specially below.
    /* Op_enter     */  {   imm, imm, I5    },  // operands *not* reversed for gas, %% inform gcc of EBP clobber?,
    /* Op_fdisi     */  {   0,0,0,           0, 0, Out_Mnemonic, Mn_fdisi },
    /* Op_feni      */  {   0,0,0,           0, 0, Out_Mnemonic, Mn_feni },
    /* Op_fsetpm    */  {   0,0,0,           0, 0, Out_Mnemonic, Mn_fsetpm },
    /* Op_fXstsw    */  { D|mr,  0,   0,     I4 }, // ax is the only allowed register
    ...
    /* Op_imul1     */  {   mr,  0,   0,     1, Clb_Flags|Clb_SizeDXAX,  I2 },
    /* Op_in        */  { D|ax,N|port,0,     1, I3  },
    /* Op_ins       */  {   mem,N|dx, 0,     1, Clb_DI, I2  }, // can't override ES segment for this one
    /* Op_insX      */  {   0,   0,   0,     0, Clb_DI, I2  }, // output segment overrides %% needs work
    /* Op_iret      */  {   0,0,0,           0, 0, Out_Mnemonic, Mn_iretw },
    /* Op_iretd     */  {   0,0,0,           0, 0, Out_Mnemonic, Mn_iret  },
    /* Op_lods      */  {   mem, 0,   0,     1, Clb_SI, I2  },
    /* Op_lodsX     */  {   0,   0,   0,     0, Clb_SI, I2  },
    /* Op_movs      */  {   mem, mem, 0,     1, Clb_DI|Clb_SI, I2 }, // only src/DS can be overridden
    /* Op_movsd     */  {   0,   0,   0,     0, Clb_DI|Clb_SI, Next_Form, Op_DstSrcSSE }, // %% gas doesn't accept movsd .. has to movsl
    /* Op_movsX     */  {   0,   0,   0,     0, Clb_DI|Clb_SI, I2 },
    /* Op_movsx     */  { D|reg, mr,  0,     1, I3  }, // type suffix is special case
    /* Op_movzx     */  { D|reg, mr,  0,     1, I3  }, // type suffix is special case
    /* Op_mul       */  { U|ax,  mr,  0,     1, Clb_SizeDXAX|Clb_Flags, Next_Form, Op_Src_DXAXF },
    /* Op_out       */  { N|port,ax,  0,     1, I3  },
    /* Op_outs      */  { N|dx,  mem, 0,     1, Clb_SI, I2  },
    /* Op_outsX     */  {   0,   0,   0,     0, Clb_SI, I2  },
    /* Op_push      */  {   mri, 0,    0,    Word_Types, Clb_SP, I2 }, // would be Op_SrcW, but DMD defaults to 32-bit for immediate form
    /* Op_ret       */  {   imm, 0,   0,     0, 0, Next_Form, Op_0  },
    /* Op_retf      */  {   0,   0,   0,     0, 0, Out_Mnemonic, Mn_lret  },
    /* Op_scas      */  {   mem, 0,   0,     1, Clb_DI|Clb_Flags, I2},
    /* Op_scasX     */  {   0,   0,   0,     0, Clb_DI|Clb_Flags, I2},
    /* Op_stos      */  {   mem, 0,   0,     1, Clb_DI, I2  },
    /* Op_stosX     */  {   0,   0,   0,     0, Clb_DI, I2  },
    /* Op_xlat      */  {   mem, 0,   0,     0, Clb_SizeAX, I2  }
