...
+++ gcc/tree-nested.c	2011-07-09 20:25:41.465656814 +0100
...
@@ -2053,6 +2055,25 @@ convert_gimple_call (gimple_stmt_iterato
...
+
     default:
       ...
       *handled_ops_p = false;
@@ -2407,8 +2428,38 @@ finalize_nesting_tree_1 (struct nesting_
       gimple bind;
