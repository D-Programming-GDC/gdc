...
/* True if decl is a record generated by d2tree.
   TREE_TYPE should be treated as the same type decl is assigned to. */
#define D_IS_CTOR_ELEMLIST(NODE) (TREE_LANG_FLAG_1(NODE))
