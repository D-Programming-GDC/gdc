...
version(GNU) alias gcc.config.cosl cos; else
...
version(GNU) alias gcc.config.sinl sin; else
...
version(GNU) alias gcc.config.tanl tan; else
real tan(real x)
{
    asm
    {
...
version(GNU) float sqrt(float x) { return gcc.config.sqrtf(x); } else
float sqrt(float x);	/* intrinsic */
version(GNU) double sqrt(double x) { return gcc.config.sqrt(x); } else /// ditto
double sqrt(double x);	/* intrinsic */	/// ditto
version(GNU) real sqrt(real x) { return gcc.config.sqrtl(x); } else /// ditto
...
version(GNU) alias gcc.config.ldexpl ldexp; else
 ...
 */
version(GNU) alias gcc.config.rintl rint; else
